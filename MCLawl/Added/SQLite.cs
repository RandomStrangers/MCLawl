...
namespace MCLawl
{
    public sealed class SQLiteBackend : IDatabaseBackend
    {
        ...
        public override void LoadDependencies()
        {
            ...
            Utils2.CheckFile("sqlite3_x32.dll");
            Utils2.CheckFile("sqlite3_x64.dll");
            ...
            catch (Exception ex)
            {
                ...
                Server.s.Log("Error moving SQLite dll");
            }
        }
    ...
    {
        protected override bool ConnectionPooling { get { return Server.DatabasePooling; } }

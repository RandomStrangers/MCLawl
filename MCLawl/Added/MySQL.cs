...
namespace MCLawl
{
    public sealed class MySQLBackend : IDatabaseBackend
    {
        ...
        public override ISqlConnection CreateConnection()
        {
            ...
            string str = string.Format(format, Server.MySQLHost, Server.MySQLPort,
        ...
        {
            Utils2.CheckFile("MySql.Data.dll");
        }

        public override void CreateDatabase()
        {
            string sql = "CREATE DATABASE if not exists `" + Server.MySQLDatabaseName + "`";
        ...
        public override bool TableExists(string table)
        {
            ...
            string column = "Tables_in_" + Server.MySQLDatabaseName;
            bool found = false;
